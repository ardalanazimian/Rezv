...
function nav(v){
  ...
  ({overview:rOverview,restaurants:rRestaurants,detail:rDetail,analytics:rAnalytics,customers:rCustomers,billing:rBilling,sales:loadSales,photos:loadPhotos,systemhealth:rSystemHealth,aihealth:rModelHealth,security:rSecurity,support:rSupport,badges:rBadges,missions:rMissions})[v]();
