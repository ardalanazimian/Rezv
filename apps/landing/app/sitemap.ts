...
// ═══════════════════════════════════════════════════════════════════════
//  sitemap.xml پویا — صفحاتِ بازاریابی + مقاله‌ها + صفحه‌های ساخته‌شده در استودیو
//
//  ⚠️ صفحاتِ رستوران (/r، /city، /cuisine) عمداً اینجا نیستند: آن‌ها مالِ اپِ
//  apps/seo روی دامنه‌ی خودش‌اند و sitemap مستقلِ خودشان را دارند. اعلامِ
//  آدرسی که این اپ سرو نمی‌کند، یعنی ۴۰۴ در sitemap.
//
