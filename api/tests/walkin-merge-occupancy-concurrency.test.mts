...
//  تکرار نکند.
//
//  ⚠️ این تست امروز (۲۰۲۶-۰۹-۰۴) **قرمز** است — عمداً. قرمزی‌اش خودِ مدرکِ
//  P0 است: چکِ اپلیکیشنیِ isTableNumberOccupied به‌تنهایی، زیرِ READ
//  COMMITTED، محافظِ کافی نیست. تبدیل‌کردنِ isolationLevelِ createWalkinTx
//  به Serializable (هم‌سو با placeReservation، reservations.ts:396) بخشی
//  از همون P0 است، نه یک فالوآپِ جدا — با امضایِ معمار و PRِ مجزا، طبقِ
//  دستورِ ممیزی. سبزشدنِ این تست، معیارِ پذیرشِ آن رفع خواهد بود.
//
