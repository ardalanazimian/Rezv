...
--     ⚠️ ۲۰۲۶-۰۹-۱۷: با دفترهای فقط-افزودنیِ مهاجرتِ ۰۹۰ سازگار نیست — FKهای دفتر به
--     reservations پس از جابه‌جایی به reservations_old می‌روند و DROP … CASCADE آن‌ها را بی‌صدا
--     حذف می‌کند (ردیفِ دفتر با ارجاعِ یتیم می‌ماند). شرحِ اندازه‌گیری: 011-reservations-partitioning.sql.
...
--    ⚠️ (۲۰۲۶-۰۹-۱۷) این دستور با وجودِ FKِ دفترها رد می‌شود؛ نسخه‌ی CASCADE آن FKها را بی‌صدا
--    حذف می‌کند. پیش از اجرا سیاستِ نگه‌داری را با FP-009 و مهاجرتِ ۰۹۰ تطبیق بده.
--
