...
اسکیمای پایگاه‌داده از قبل اعمال شده. ⚠️ عددهایِ «۳۷ جدول / RLS روی همه / ۱۳
migration» قدیمی‌ان — schema.prisma الان ۴۹ مدل داره، و طبقِ یافته‌ی
live-testِ ۲۰۲۶-۰۸-۱۲ (رجوع کن به `PROJECT-KNOWLEDGE.md` §۲) یک DBِ **تازه‌ساز**
از رویِ migrationهایِ فعلی فقط RLS رویِ ۱۵ از ۴۹ جدول فعال می‌کنه، نه همه —
قبل از تکیه‌کردن به «RLS روی همه» برایِ یک محیطِ تازه، حتماً اون بخش رو بخون.
