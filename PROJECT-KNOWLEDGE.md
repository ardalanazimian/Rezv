...
سطحِ DB برایِ این جدول‌ها روی محیطِ تازه فعال نیست. این یافته گزارش شده،
عمداً خودم migration ننوشتم — تصمیم دربارهٔ اضافه‌کردنِ RLS به این‌همه
جدولِ اصلی باید صریح و با تأییدِ انسانی باشه (تغییرِ امنیتی/DB پرریسک).
