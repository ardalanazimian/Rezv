> تولیدشده توسطِ `node tools/gate-inventory.mjs` در 2026-09-04T07:44:14.554Z روی DESKTOP-8DAJNO5 (win32 10.0.26200, node v24.20.0). **این جدول یک عکسِ لحظه‌ای است، نه یک ادعای دائمی — دوباره اجرا کن، اعتماد نکن.**
