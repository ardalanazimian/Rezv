> تولیدشده توسطِ `node tools/report-gate-status.mjs` در 2026-09-07T04:53:15.143Z روی DESKTOP-8DAJNO5 (win32 10.0.26200, node v24.20.0). **این جدول یک عکسِ لحظه‌ای است، نه یک ادعای دائمی — دوباره اجرا کن، اعتماد نکن.**
...
| A3 decision (--id D-004) | `node tools/gate-decision.mjs --id D-004` | 0 | GREEN | evidence: `audit/round-20/gate-inventory/decision-D-004.log` |
...
| XSS sink audit (--check) | `node tools/xss-sink-audit.mjs --check` | 0 | GREEN | evidence: `audit/round-20/gate-inventory/xss-sink-audit-check.log` |
