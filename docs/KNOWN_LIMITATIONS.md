...
## فیدِ «محبوب امشب» به ترتیبِ UUID مرتب می‌شود، نه محبوبیت

**تاریخ:** ۲۰۲۶-۰۸-۲۵ · **وضعیت:** باز — یافته‌ی تأییدشده، رفع‌نشده
...
**تا وقتی هیچ‌کدام انجام نشده، محصول یک ادعایِ اثباتی‌نشده روی صفحه‌ی اولش
دارد.**
