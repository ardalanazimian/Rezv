...
| **Backend Engineer** | *ردیف هنوز نوشته نشده* — منشور: `docs/audit/prompts/backend-engineer.md` | **مالک ۲۰۲۶-۰۹-۱۰ بازش کرد.** ردیف مالِ خودِ آن نشست است تا از روی transcriptِ خودش بنویسد. غیبتش یعنی «هنوز ننوشته»، **نه** «نقش پر نشده». آن را از روی جای‌گاه در `ListAgents` پر نکن |
