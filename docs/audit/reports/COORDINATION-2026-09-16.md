...
| `docs/audit/directives/` · Reviewer `baa73640` | 09-11 | nothing | 046 residuals · 047 DB decision · 050/051 CI rulings | Accepted. 046 open (m-06), 048 closed, 049 closed by `ad93943`, 047/050/051 not re-verified this pass |
...
| Reviewer `baa73640` | 6 (100% of 09-10+) | 3 | 0 (1 stale) | 3 not re-derived |
...
| Sync `rezv-7a` | 8 | 6 | **2 wrong → corrected by the author** | C-8, C-9; its re-run is accepted |
